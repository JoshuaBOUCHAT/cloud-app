use crate::{
    ...
    constants::messages::{
        CREDENTIALS_INCORECT, EMAIL_ALREADY_EXIST, TOKEN_EXPIRED, USER_LOGGED_OUT, USER_NOT_LOGIN,
...
#[post("/verify")]
pub async fn verify(auth_state: AuthState, Query(verify_key): Query<VerifyKey>) -> APIResponse {
    eprintln!("here ! heheh");
    // --- Case 1 : User already connected ---
